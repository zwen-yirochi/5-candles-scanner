...
import { FPSMeter, getMemoryUsage } from '../utils/performance';
...
export const PerformanceMonitor: React.FC<{ enabled?: boolean }> = ({ enabled = false }) => {
  ...
  return (
    <div className="fixed z-50 p-3 text-xs font-mono text-white bg-black bg-opacity-80 rounded-lg shadow-lg top-4 right-4">
