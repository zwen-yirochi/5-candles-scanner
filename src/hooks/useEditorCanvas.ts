...
import { indexToPixel, priceToPixel, timestampToIndex } from '../utils/domainToRange';
...
export const useEditorCanvas = () => {
  ...
  }, [width, height, domain, range, candles, drawingObjects, draftObject, selectedId]);
